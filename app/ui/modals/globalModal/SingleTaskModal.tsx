...
//     const managerId = session?.user.email; // Получаем ID менеджера
//     const router = useRouter();

// console.log("managerId 000", managerId);
...
//         const candidateId = candidate._id; // Убедитесь, что selectedCandidate определен
...
//             <p>Опишите поставленую задачу</p>
